...
export const QARIS = [
  ...
  { id: 'minshawi', name: 'المنشاوي',   folder: 'Minshawy_Murattal_128kbps' },
  { id: 'basit',    name: 'عبد الباسط', folder: 'Abdul_Basit_Murattal_192kbps' },
  { id: 'ghamdi',   name: 'الغامدي',   folder: 'Ghamadi_40kbps' },
];
...
export const ALL_QARIS = [
  ...
  { id: 'minshawi', name: 'الشيخ محمد صديق المنشاوي',    subtitle: 'رواية حفص — مرتّل',       folder: 'Minshawy_Murattal_128kbps',     icon: 'account-music-outline' },
  ...
  { id: 'ghamdi',   name: 'الشيخ سعد الغامدي',           subtitle: 'رواية حفص — تلاوة عادية', folder: 'Ghamadi_40kbps',                icon: 'microphone' },
];
